...
```{r}
#| label: Final Model
model11 <- lmer(hit_distance_sc ~ launch_angle_gmc + I(launch_angle_gmc^2)*launch_speed_gmc + stand + is_fastball + (1 + I(launch_angle_gmc^2) | batter), data=final_data, REML = TRUE)
