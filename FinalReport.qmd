...
The data were collected from January 2009 were updated monthly to the London Data Store [@lfbdata2016] until May 2021. Considering the 2021 data does not cover the entire year, we only examined calls made up to the end of 2020. Over this twelve year period, 7,544 animal rescue calls were made.
...
The proportion of night-time incidents for pets and wild animals are 35% and 30%, respectively (@tbl-night-summary). We should note that a much larger number of pet incidents occurred, compared to wild animals, when investigating sample sizes.
