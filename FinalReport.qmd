...
```{r include = FALSE}
#| label: Final Model
model11 <- lmer(hit_distance_gmc ~ launch_angle_gmc + I(launch_angle_gmc^2)*launch_speed_gmc + standR + is_fastball + (1 + launch_angle_gmc + I(launch_angle_gmc^2) | batter), data=final_data, REML = TRUE)
